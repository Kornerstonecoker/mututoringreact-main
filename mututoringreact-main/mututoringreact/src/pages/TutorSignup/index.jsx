...
import { registerTutor, checkVerified } from '../../endpoints'
...
export const TutorSignup = () => {
  ...
  const submit = (e) => {
    ...
    registerTutor({ email, password, firstName, lastName }).then((response) => {
    ...
    <Container>
      <FormWrap>
        ...
        <FormContent>
          ...
          <Text onClick={() => window.location.href = '/login/T'}
